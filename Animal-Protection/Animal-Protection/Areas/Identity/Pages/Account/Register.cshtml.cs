...
namespace Animal_Protection.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<AnimalProtectionUser> _signInManager;
        private readonly UserManager<AnimalProtectionUser> _userManager;
        private readonly IUserStore<AnimalProtectionUser> _userStore;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AnimalProtectionUser { UserName = Input.Email, Email = Input.Email, 
        ...
        private AnimalProtectionUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<AnimalProtectionUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(AnimalProtectionUser)}'. " +
                    $"Ensure that '{nameof(AnimalProtectionUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<AnimalProtectionUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<AnimalProtectionUser>)_userStore;
        }
    }
}
